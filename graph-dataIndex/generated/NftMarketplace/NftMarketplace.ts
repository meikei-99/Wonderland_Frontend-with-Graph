...
export class SoldItemDelisted extends ethereum.Event {
  get params(): SoldItemDelisted__Params {
    return new SoldItemDelisted__Params(this);
  }
}

export class SoldItemDelisted__Params {
  _event: SoldItemDelisted;

  constructor(event: SoldItemDelisted) {
    this._event = event;
  }
