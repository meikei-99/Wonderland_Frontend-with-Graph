...
export class CancelListing extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type CancelListing must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("CancelListing", id.toString(), this);
    }
  }

  static load(id: string): CancelListing | null {
    return changetype<CancelListing | null>(store.get("CancelListing", id));
  }
...
export class SoldItemDelisted extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save SoldItemDelisted entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type SoldItemDelisted must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("SoldItemDelisted", id.toString(), this);
    }
  }

  static load(id: string): SoldItemDelisted | null {
    return changetype<SoldItemDelisted | null>(
      store.get("SoldItemDelisted", id)
    );
  }
